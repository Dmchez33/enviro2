...
/**
 * @package contact_artisanat
 * @version 1.7.2
 */
/*
Plugin Name: contact_artisanat
Plugin URI: http://wordpress.org/plugins/hello-dolly/
Description: Ceci est une description de notre pligin de formulaire de cantact
Version: 1.7.2
...
$content .= '<input  type="submit" value="Envoyer" name="custumcontact_submit" style=" background:green;color:white;border-color:white;" />';
$content .= '</div>';
$content .= '</form>';
$content .= '</div>';
$content .= '</body>';
...
// Administrateur system
        $to = 'dembeidrissa0@gmail.com.com';
        $NOM = $nom;
        $subject = $objet;
...
add_shortcode('contact_artisanat','Contact_Plugin');