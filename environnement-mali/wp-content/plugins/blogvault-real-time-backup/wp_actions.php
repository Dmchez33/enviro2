	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, '27170612f10441fd63397c211e9b9cd7', '2df61ee81fc9f35bbeff74e4ec837de9');
		BVAccount::updateApiPublicKey($this->settings, '27170612f10441fd63397c211e9b9cd7');
			}
